...
<link rel="stylesheet" type="text/css" href="../prefer/p3/css/main.css">
<!--[if lt IE 9]>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div class="utilities">
        ...
        <a class="button right" href="#" onClick="history.go(-1);return true;">返回...</a><a class="button right" >联系站长</a>
        <div class="clear"></div>
      </div>
    </div>
    <div id="footer">
